...
#: components grows. Beyond this many, the estimate is still exact (counts add)
#: but the margin of error is reported as unavailable rather than overstated.
    ...
    for geoid in geoids:
        ...
        if measure.kind != "count":
            ...
            bench.moe_reason = (
                ...
                "not store separately. The combined estimate is exact; its "
