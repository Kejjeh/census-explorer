...
| Offline test suite | Working: 466 Python tests (Linux) plus 42 Node tests of the page logic, no network; cached files read identically with LF or CRLF line endings |
...
```powershell
python -m unittest discover -s tests -t .          # 466 offline tests on Linux
