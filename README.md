...
| Offline test suite | Working: 461 Python tests (Linux) plus 40 Node tests of the page logic, no network; cached files read identically with LF or CRLF line endings |
...
```powershell
python -m unittest discover -s tests -t .          # 461 offline tests on Linux
